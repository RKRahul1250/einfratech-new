        ...
        <div className="features-hero-wrapper">
          <div className="container">
            <div className="row align-items-left">
              <div className="col-lg-7 order-last order-lg-first" style={{ paddingLeft: '8rem' }}>
                <style>
                  {`
                ...
                <motion.h1
                  ...
                  className="mb-4 text-left text-lg-start education-hero-title"
                  style={{
                    fontSize: '3rem',
                    fontWeight: 'bold',
                    lineHeight: '1.2'
                ...
                >
                  Empowering{' '}
                  <span className="highlight">Digital Learning</span>
                  <br /> {" "}
                  & Collaboration
                </motion.h1>
                ...
                <motion.p
                  ...
                  className="mb-4 education-hero-text"
                  style={{
                    textAlign: 'left',
                    paddingLeft: '0',
                    marginLeft: '0',
                ...
                >
                  <li><span>✔️</span> Smart Classroom Solutions</li>
                  <li><span>✔️</span> E-Learning Platforms</li>
                  <li><span>✔️</span> Interactive Learning Tools</li>
                  <li><span>✔️</span> Education Analytics</li>
                </motion.ul>
