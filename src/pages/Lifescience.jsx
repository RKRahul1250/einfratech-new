...
const LifeScience1 = () => {
                        ...
                        <div className="row align-items-left">
                            <div className="col-lg-7 order-last order-lg-first" style={{ paddingLeft: '8rem' }}>
                                ...
                                <motion.h1
                                    ...
                                    className="mb-4 text-left text-lg-start services-hero-title"
                                    style={{
                                        fontSize: '3rem',
                                        fontWeight: 'bold',
                                        lineHeight: '1.2'
                                ...
                                >
                                    Advanced{' '}
                                    <span className="highlight">Life Sciences</span>
                                    <br/> {" "}
                                    Solutions
                                </motion.h1>
                                ...
                                <motion.p
                                    ...
                                    className="mb-4 services-hero-text"
                                    style={{ 
                                        textAlign: 'left', 
                                        paddingLeft: '0',
                                        marginLeft: '0',
  ...
  >
    <motion.div 
      className="col-md-10 order-md-1"
      initial={{ opacity: 0, x: -50 }}
      whileInView={{ opacity: 1, x: 0 }}
      viewport={{ once: true }}
      transition={{ duration: 0.6, delay: 0.2 }}
